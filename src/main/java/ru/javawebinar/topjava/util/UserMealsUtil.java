...
public class UserMealsUtil {
    ...
    public static List<UserMealWithExcess> filteredByCycles(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal userMeal : meals) {
                caloriesPerDays.merge(userMeal.getLocalDate(), userMeal.getCalories(), Integer::sum);
        }
        for (UserMeal userMeal : meals) {
            if (TimeUtil.isBetweenHalfOpen(userMeal.getLocalTime(), startTime, endTime)) {
                result.add(new UserMealWithExcess(userMeal, caloriesPerDays.get(userMeal.getLocalDate()) > caloriesPerDay));
            }
        }
        return result;
    }
    ...
    public static List<UserMealWithExcess> filteredByStreams(List<UserMeal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        return meals.stream()
                ...
                .map(meal -> new UserMealWithExcess(meal, caloriesPerDays.get(meal.getLocalDate()) > caloriesPerDay))
